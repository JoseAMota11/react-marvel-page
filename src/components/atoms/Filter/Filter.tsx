      ...
      {section === 'CHARACTERS' ? (
        <div className="filter--container__characters">
          ...
          >
            ...
            <option value="8">
              In the wake of September 11th, the world watched as firefighters,
              police officers and EMT workers selflessly risked their lives
            </option>
            <option value="9">
              Ordinary New York City cop Frankie &QUOT;Gunz&QUOT; Gunzer now has
              a new call to duty Ñ not just to uphold the law, but to save
            </option>
            <option value="10">
            ...
            <option value="14">
              ...
              identity for a drug fix. Matt Murdock must find strength as the K
            </option>
            <option value="15">
            ...
            <option value="17">
              ...
              atmosphere that made Miller's Daredevil classic Ñ including appea
            </option>
          </select>
        </div>
      ) : null}
